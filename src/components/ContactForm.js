...
export const ContactForm = () => {
  ...
  return (
    <div className="bg-stone-200 w-full flex flex-wrap justify-center items-center h-[calc(100vh-200px)]">
        ...
        <form className="mx-auto my-auto w-[60%] max-w-[500px]" ref={form} onSubmit={sendEmail}>
            ...
            <input type="submit" value="Send" className="hover:text-slate-900 hover:bg-white/30 border rounded-xl border-stone-400 px-4 py-2 cursor-pointer"/>
        </form>
    </div>
  );
};